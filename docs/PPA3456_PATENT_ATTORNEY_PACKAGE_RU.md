...
**Рисунки:** ⬜ `PPA#7 FIGURES.pdf` (уточнить у заявителя; описание ФИГ. 1–4 — в §1)  
...
> Официальные рисунки — `PPA#7 FIGURES.pdf` (когда приложены). Ниже — концептуальные эскизы по тексту заявки.
